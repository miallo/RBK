...
\subsection{Nußelt-Zahl}
Die Nußelt-Zahl kann entweder nach Formel \ref{eq:nu_grenz} aus der Dicke der Grenzschicht oder (in Simulationen) aus dem Integral über den Temperaturgradienten (Gleichung \ref{eq:nu_num}) bestimmt werden.
