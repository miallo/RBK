...
Ebenfalls kann man anhand der Kurve sehen, dass die Ausbildung von Plumes kein unabh\"angiger Vorgang ist.
W\"are dies der Fall, so m\"usste die Korrelation f\"ur $t=0$ verschwinden.
Es zeigt sich jedoch, dass der Wert nur $\approx20\%$ niedriger ist, als das Maximum.
Da die Str\"omung jedoch der Kausalit\"at gen\"ugen muss, ist anzunehmen, dass die Korrelation daher stammt, dass ein sich bildender Plume die Bedingungen f\"ur die Entstehung des n\"achsten Plumes ver\"andert.
Dadurch kann man nicht ohne Weiteres aus der Breite der Verteilung einen R\"uckschluss auf die Geschwindigkeitsverteilung der Plumes machen.
